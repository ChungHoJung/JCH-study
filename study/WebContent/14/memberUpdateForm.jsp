...
<body>
	...
	<table class ="table">
		<tbody>
			<tr>
				<td>아이디</td>
				<td><input type = "text" name = "userId" value = "${userInfo.memId}"
			...
			<tr>
				<td>폰번호</td>
				<td><input type = "text" name = "userPhone" value = "${userInfo.memPhone}"></td>
			</tr>
			<tr>
				<td>메일</td>
				<td><input type = "email" name = "userEmail" value = "${userInfo.memEmail}"></td>
			</tr>
			<tr>
				<td colspan="2">
